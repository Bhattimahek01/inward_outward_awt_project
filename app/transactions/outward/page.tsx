...
export default function OutwardEntry() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const [entriesData, officesData, modesData, couriersData, fromTosData] = await Promise.all([
                entriesRes.json(),
                officesRes.json(),
                modesRes.json(),
                couriersRes.json(),
            ...
            setFromTos(fromTosData);

            if (officesData.length > 0 && !editingId) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const body = editingId ? { ...formData, OutwardID: editingId } : formData;
